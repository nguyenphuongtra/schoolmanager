...
public class CourseSectionAdminController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('SUPER_ADMIN','ACADEMIC_AFFAIRS','LECTURER') or hasAuthority('course_section:read')")
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('SUPER_ADMIN','ACADEMIC_AFFAIRS') or hasAuthority('course_section:create')")
    public CourseSection create(@RequestBody CourseSection cs) {
        return service.create(cs);
    }

    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('SUPER_ADMIN','ACADEMIC_AFFAIRS') or hasAuthority('course_section:update')")
    public CourseSection update(@PathVariable UUID id, @RequestBody CourseSection cs) {
        return service.update(id, cs);
    }

    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyRole('SUPER_ADMIN','ACADEMIC_AFFAIRS') or hasAuthority('course_section:delete')")
