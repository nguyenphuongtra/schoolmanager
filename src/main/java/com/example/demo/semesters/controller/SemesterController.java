...
public class SemesterController {
    ...
    @GetMapping
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('SEMESTER_VIEW')")
    ...
    @PostMapping
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('SEMESTER_CREATE')")
    public Semester create(@RequestBody Semester semester) {
        return service.create(semester);
    }

    @PutMapping("/{id}")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('SEMESTER_UPDATE')")
    public Semester update(@PathVariable UUID id, @RequestBody Semester semester) {
        return service.update(id, semester);
    }

    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('SEMESTER_DELETE')")
